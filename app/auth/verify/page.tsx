...
export default function VerifyEmailPage() {
  ...
  // Error state - show context-specific UI based on error code
  const getErrorTitle = () => {
    switch (errorCode) {
      case 'TOKEN_USED':
  ...
  // For TOKEN_USED, show a simpler UI with just login link (no resend form)
  if (errorCode === 'TOKEN_USED') {
    return (
      <div className="min-h-screen bg-[#0B1220] flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-[#0F172A] border border-white/5 rounded-xl shadow-lg p-8">
  ...
  // For other errors (TOKEN_EXPIRED, MISSING_TOKEN, etc.)
  return (
    <div className="min-h-screen bg-[#0B1220] flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-[#0F172A] border border-white/5 rounded-xl shadow-lg p-8">
        <div className="flex justify-center mb-6">
